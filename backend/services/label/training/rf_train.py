# backend/services/label/training/rf_train.py
from pathlib import Path
import argparse
from tqdm.auto import tqdm
from ..model.random_forests import train_rf_model
...
STAGES = [
    ...
    "rf_fit_start", "rf_fit_done",
    "eval_start", "eval_done",
    "save_start", "save_done",
]

def main():
    ap = argparse.ArgumentParser(description="Train Random Forest text classifier (with progress)")
